...
var transaction_1 = require("./tx/transaction");
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var txPath, txArgs, transactionCode;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    txArgs = (_a.sent()).args;
                    transactionCode = fs.readFileSync(path.join(__dirname, txPath), 'utf8');
                    return [4 /*yield*/, (0, transaction_1.send)(transactionCode, txArgs)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
